...
with sync_playwright() as p:
    ...
    cedula="0102752763"
    contraseña="mariana2023"
    page.goto("https://app.iess.gob.ec/iess-gestion-agendamiento-citas-medicas-web/login/login.jsf")
    time.sleep(3)
    page.locator("input[data-p-rmsg='Ingrese su usuario.']").type(cedula, delay=100);
    time.sleep(2)
    page.locator("input[id='formLogin:keyPassword']").type(contraseña, delay=200);    
